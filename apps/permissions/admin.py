...
class RoleAdmin(admin.ModelAdmin):
    ...
    def get_readonly_fields(self, request, obj=None):
        if obj and obj.is_system:
            return ("name", "slug", "is_system", "level", "inherits_from",
...
class UserPermissionOverrideAdmin(admin.ModelAdmin):
    list_display = ("user", "permission", "store", "is_granted",
                    "expires_at", "granted_by", "created_at")
...
class SubscriptionPlanAdmin(admin.ModelAdmin):
    list_display = ("name", "slug", "price", "billing_period", "is_active",
                    "is_public", "max_users", "max_stores", "sort_order")
...
class SubscriptionAdmin(admin.ModelAdmin):
    list_display = ("store", "plan", "status", "current_period_end", "trial_ends_at")
...
class SubscriptionEventAdmin(admin.ModelAdmin):
    ...
    search_fields = ("subscription__store__name", "event_type")
    readonly_fields = ("created_at", "updated_at")
